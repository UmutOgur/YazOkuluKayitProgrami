<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="OgrenciGüncelle.aspx.cs" Inherits="OgrenciGüncelle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <form id="Form1" runat="server">
        <div class="form-group">
              <div>
                <strong>
                <asp:Label for="TxtId" runat="server" Text="ÖĞRENCİ ADI"></asp:Label>
                </strong>
        ...
        <asp:Button ID="Button1" runat="server" Text="ÖĞRENCİ GÜNCELLE"  CssClass="btn btn-info" OnClick="Button1_Click" />
    </form>
